...
## Strings
  ...
  * <a name="consistent-string-literals"></a>
    ...
    NOTE: This guide was written initially with single quotes as default except for
    interpolation. Goldstar has chosen double quotes by default - keep that in mind
    when you are interpreting this guide.
